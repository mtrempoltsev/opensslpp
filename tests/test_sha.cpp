...
TEST(sha512, common)
{
    ...
    ASSERT_TRUE(opensslpp::Sha512::calculate("test1", digest1));

    opensslpp::Sha512::Digest digest2;
    ASSERT_TRUE(opensslpp::Sha512::calculate("test2", digest2));

    opensslpp::Sha512::Digest digest3;
    ASSERT_TRUE(opensslpp::Sha512::calculate("test1", digest3));
